 ...
 */
final class Version20240923151406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD views INT NOT NULL, ADD purchases INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game DROP views, DROP purchases');
        $this->addSql('ALTER TABLE user CHANGE banned banned TINYINT(1) DEFAULT 0');
    }
}
